...
if (num1 > num2) {
  ...
  console.log(num1 + " è più piccolo");
}
...
if (n1 === 8 || n2 === 8 || n1 + n2 === 8 || n1 - n2 === 8) {
  console.log("Uno dei due numeri, la loro somma o la loro sottrazione sono uguali a 8")
}
else {
  console.log("Nessuno dei casi si è verificato")
}
...
let totale = 50
if(totale > 50){
  console.log("Devi pagare "+ totale )
}
else {
  totale = totale + 10;
  console.log("Devi pagare " + "10 euro di spedizione")
}
...
if(totale > 50){
  console.log("Avrai uno sconto di" + totale)
}
